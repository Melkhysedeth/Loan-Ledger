...
export default function PaymentScreen() {
  ...
  const { carryover, nextExpectedInterest } = calcInterestCarryover(
    loan,
    payments,
  );
  const baseInterest =
      ...
      <div className="px-4 pt-4 space-y-4">
        ...
        {mora.inMora && (
          <div className="border border-red-200 dark:border-red-900/50 bg-white dark:bg-gray-800 rounded-2xl p-4">
            <p className="text-sm font-bold text-red-500 dark:text-red-400 mb-2">
              ⚠ Cuenta en mora
            </p>
            ...
            {capitalNum > 0 && (
              <p className="text-xs text-gray-400 mt-1.5">
                ...
                <span className="text-amber-500 font-semibold">
                  {formatCOP(remaining - capitalNum)}
                </span>
              </p>
            )}
          </div>
